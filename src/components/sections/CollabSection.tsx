            ...
            >
              ...
              <div className="mx-auto mb-2 sm:mb-4 flex items-center justify-center bg-white">
                <img
                  src={collab.skin}
                  alt={collab.name}
                  className="w-20 h-20 sm:w-28 sm:h-28 md:w-48 md:h-32 lg:w-60 lg:h-40 object-contain"
                />
              </div>

              <h3 className="text-[10px] sm:text-xs font-minecraft text-ore-gold leading-tight">
                {collab.name}
              </h3>
            </PixelCard>
          ))}
