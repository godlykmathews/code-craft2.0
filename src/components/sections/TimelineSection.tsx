                    ...
                    <p className="text-[10px] sm:text-xs font-minecraft text-muted-foreground mt-2">
                      {item.description}
                        ...
                        <div className="hidden md:flex md:w-2/12 justify-center">
                          ...
                          <img src={`/${item.blockType}`} alt={item.title} className="w-24 h-24" />
                          </div>
                        </div>
